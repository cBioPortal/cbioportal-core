...
@Rollback
@Transactional
public class ITNormalizeExpressionLevels {
	...
	public void initialize() {
		...
		URL url1 = ITNormalizeExpressionLevels.class.getResource("/test_all_thresholded.by_genes.txt");
		URL url2 = ITNormalizeExpressionLevels.class.getResource("/test_PR_GDAC_CANCER.medianexp.txt");
		URL url3 = ITNormalizeExpressionLevels.class.getResource("/data_mRNA_ZbyNorm.txt");

...
public class ImportWsiDataTest {
    ...
    @Test
    public void slideTypeMustAgreeWithResolvedFlags() {
        assertEquals("H&E", ImportWsiData.validatedSlideType("H&E", true, false, 6));
        assertEquals("IHC", ImportWsiData.validatedSlideType("IHC", false, true, 6));
        assertEquals("Other", ImportWsiData.validatedSlideType("Other", false, false, 6));
        assertThrows(IllegalArgumentException.class,
            () -> ImportWsiData.validatedSlideType("", false, true, 6));
        assertThrows(IllegalArgumentException.class,
            () -> ImportWsiData.validatedSlideType("H&E", false, true, 6));
        assertThrows(IllegalArgumentException.class,
            () -> ImportWsiData.validatedSlideType("IHC", true, true, 6));
    }

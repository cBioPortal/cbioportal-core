...
public class DaoCoexpression {
    public static int addCoexpression(Coexpression coexpression) throws DaoException {
            if (!ClickHouseBulkLoader.isBulkLoad()) {
                throw new DaoException("You have to turn on ClickHouseBulkLoader in order to insert Coexpression data");
            } else {
                    // use this code if bulk loading
                    // write to the temp file maintained by the ClickHouseBulkLoader
                    ClickHouseBulkLoader.getClickHouseBulkLoader("coexpression").insertRecord(
